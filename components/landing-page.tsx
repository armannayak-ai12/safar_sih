...
const benefits = [
  { titleLine1: "Personalized", titleLine2: "Itineraries", icon: CompassIcon },
  { titleLine1: "Fair Fare", titleLine2: "Guidance", icon: RupeeIcon },
  { titleLine1: "Verified", titleLine2: "Partners", icon: PartnersIcon },
  { titleLine1: "Safer", titleLine2: "Travel", icon: ShieldIcon },
];
    ...
    <main className="safar-landing-page">
      ...
      <section className="safar-unified-hero">
        <div className="safar-hero-photo-layer" aria-label="Hero Destination Image">
          ...
          <div className="safar-fare-badge-floating">{currentDest.badge}</div>
          ...
          <div className="safar-dest-overlay-direct">
            ...
            <div className="safar-dest-controls">
              <button type="button" onClick={prevDest} className="safar-circle-control-btn" aria-label="Previous destination">
                <ArrowLeft />
              </button>
              <span className="safar-dest-counter">{currentDest.num} / 04</span>
              <button type="button" onClick={nextDest} className="safar-circle-control-btn" aria-label="Next destination">
                <ArrowRight />
              </button>
            </div>
          </div>
        ...
        <div className="safar-hero-body">
          <div className="safar-hero-content-col">
            <div className="safar-hero-text-block">
              <span className="safar-eyebrow">EXPLORE • PLAN • TRAVEL • SAFELY</span>
              ...
              <div className="safar-search-card-anchor">
                <Link href="/login" className="safar-btn-cta-main" style={{ marginTop: 24, alignSelf: "flex-start" }}>
                  Login / Register <ArrowRight />
                </Link>
              </div>
            ...
            <div className="safar-hero-bottom-label">— TRAVEL MORE • WORRY LESS</div>
          </div>
        </div>
      </section>
      ...
      {/* ====================================================
          SECTION 3: CORE FEATURES (informational only — no protected links)
          ==================================================== */}
          ...
          <div className="safar-features-grid">
            <div className="safar-feature-card">
              <div className="safar-feature-top">
                <div className="safar-feature-icon-box"><CompassIcon /></div>
              ...
              <div className="safar-feature-action">
                <span className="safar-feature-link">Available after login</span>
              </div>
            </div>

            <div className="safar-feature-card">
              <div className="safar-feature-top">
                <div className="safar-feature-icon-box"><RupeeIcon /></div>
                <div className="safar-feature-info">
                  <h3>Fair Fare</h3>
            ...
            <div className="safar-feature-card">
              <div className="safar-feature-top">
                <div className="safar-feature-icon-box"><PartnersIcon /></div>
                <div className="safar-feature-info">
            ...
            <div className="safar-feature-card">
              <div className="safar-feature-top">
                <div className="safar-feature-icon-box"><ShieldIcon /></div>
                <div className="safar-feature-info">
                  <h3>SAFAR Safe</h3>
      ...
      <section id="how" className="safar-section-how">
        <div className="safar-section-container">
          ...
          <p className="safar-section-lead">From your first idea to reaching your destination safely.</p>
      ...
      <section id="impact" className="safar-section-impact">
        <div className="safar-section-container">
          ...
          <div className="safar-impact-ribbon">
            <div className="safar-impact-item"><span className="safar-impact-icon">💰</span><span>Cost Saving</span></div>
            <div className="safar-impact-item"><span className="safar-impact-icon">🧭</span><span>Personalization</span></div>
            <div className="safar-impact-item"><span className="safar-impact-icon">♿</span><span>Accessibility</span></div>
            <div className="safar-impact-item"><span className="safar-impact-icon">🤝</span><span>Social Travel</span></div>
            <div className="safar-impact-item"><span className="safar-impact-icon">🛡️</span><span>Safety</span></div>
            <div className="safar-impact-item"><span className="safar-impact-icon">🌱</span><span>Smarter Tourism</span></div>
          </div>
        </div>
      </section>
      ...
      <section id="cta" className="safar-section-cta">
        <div className="safar-cta-box">
          ...
          <Link href="/login" className="safar-btn-cta-main">
            Login / Register <ArrowRight />
          </Link>
        </div>
      </section>
