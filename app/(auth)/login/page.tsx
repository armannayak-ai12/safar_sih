  ...
  return (
    <main className="auth-page">
      <div className="auth-visual" aria-hidden="true">
        ...
        <div className="auth-hill auth-hill-back" />
        <div className="auth-hill auth-hill-front" />
        <p>India is calling.<br /><em>Go with confidence.</em></p>
        <span className="auth-location">✦  Jaipur, Rajasthan</span>
      </div>
      <section className="auth-panel">
        <Link className="auth-brand" href="/"><span>S</span> SAFAR</Link>
        <div className="auth-copy">
          <p className="auth-kicker">WELCOME BACK</p>
          <h1>Your next story<br /><em>starts here.</em></h1>
        ...
        <div className="auth-actions">
          ...
          <button className="email-button" type="button">Continue with email <span>→</span></button>
        </div>
